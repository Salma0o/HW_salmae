...
time.sleep(3)
driver.find_element(By.XPATH, "//input[@name='filename']").send_keys(r"C:\Users\salma\OneDrive\Desktop\BMP.bmp")
...
assert len(NUMPRecipesBefore) == len(NUMPRecipesAfter), "added recipe with bmp file"
